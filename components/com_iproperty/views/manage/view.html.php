...
{    
    ...
    {       
        ...
        echo '<div class="ip-manage-login pull-right">'.sprintf(JText::_('COM_IPROPERTY_MANAGE_LOGIN'), $this->user->get('username')).' | <a href="'.JRoute::_('index.php?option=com_users&view=login').'">'.JText::_('COM_IPROPERTY_LOGOUT').'</a></div>';

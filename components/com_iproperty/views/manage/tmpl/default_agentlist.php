...
<div class="ip-manage-list<?php echo $this->pageclass_sfx; ?>">
    ...
    <div class="navbar">
        <div class="navbar-inner">
            ...
            <ul class="nav">
                <li><a href="<?php echo JRoute::_(ipropertyHelperRoute::getManageRoute()); ?>"><?php echo JText::_('COM_IPROPERTY_PROPERTIES'); ?></a></li>
                <li class="active"><a href="#"><?php echo JText::_('COM_IPROPERTY_AGENTS'); ?></a></li>
    ...
    <form action="<?php echo JRoute::_(ipropertyHelperRoute::getManageRoute().'&layout='.JFactory::getApplication()->input->get('layout','agentlist')); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <div class="btn-toolbar">
            <div class="btn-group">
                ...
                <?php endif; ?>                        
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('JPUBLISHED')); ?>" onclick="Joomla.submitbutton('agentlist.publish')">
                    <i class="icon-ok"></i>
                </button>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('JUNPUBLISHED')); ?>" onclick="Joomla.submitbutton('agentlist.unpublish')">
                    <i class="icon-ban-circle"></i>
                </button>
                <?php if ($this->ipauth->getAdmin() || $this->ipauth->getSuper()): ?>
                    <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_FEATURE')); ?>" onclick="Joomla.submitbutton('agentlist.feature')">
                        <i class="icon-star"></i> 
                    </button>
                    <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_UNFEATURE')); ?>" onclick="Joomla.submitbutton('agentlist.unfeature')">
                        <i class="icon-star-empty"></i> 
                    </button>
                <?php endif; ?>
                <?php if ($this->ipauth->getAdmin()): ?>
                    <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_SUPER')); ?>" onclick="Joomla.submitbutton('agentlist.super')">
                        <i class="icon-plus"></i> 
                    </button>
                    <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_UNSUPER')); ?>" onclick="Joomla.submitbutton('agentlist.unsuper')">
                        <i class="icon-minus"></i> 
                    </button>
                <?php endif; ?>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_DELETE')); ?>" onclick="if(confirm('<?php echo addslashes(JText::_('COM_IPROPERTY_CONFIRM_DELETE')); ?>')){Joomla.submitbutton('agentlist.delete')}else{return false;}">

    ...
    <div class="navbar">
        <div class="navbar-inner">
            ...
            <ul class="nav">
                ...
                <li class="active"><a href="#"><?php echo JText::_('COM_IPROPERTY_COMPANIES'); ?></a></li>
            </ul>
        </div>
    </div>
    <div class="clearfix"> </div>
    ...
    <form action="<?php echo JRoute::_(ipropertyHelperRoute::getManageRoute().'&layout='.JFactory::getApplication()->input->get('layout','companylist')); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <div class="btn-toolbar">
            <div class="btn-group">
                ...
                <?php endif; ?>                        
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('JPUBLISHED')); ?>" onclick="Joomla.submitbutton('companylist.publish')">
                    <i class="icon-ok"></i>
                </button>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('JUNPUBLISHED')); ?>" onclick="Joomla.submitbutton('companylist.unpublish')">
                    <i class="icon-ban-circle"></i>
                </button>
                <?php if ($this->ipauth->getAdmin()): ?>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_FEATURE')); ?>" onclick="Joomla.submitbutton('companylist.feature')">
                    <i class="icon-star"></i> 
                </button>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_UNFEATURE')); ?>" onclick="Joomla.submitbutton('companylist.unfeature')">
                    <i class="icon-star-empty"></i> 
                </button>
                <?php endif; ?>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_DELETE')); ?>" onclick="if(confirm('<?php echo addslashes(JText::_('COM_IPROPERTY_CONFIRM_DELETE')); ?>')){Joomla.submitbutton('companylist.delete')}else{return false;}">

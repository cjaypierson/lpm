...
<div class="ip-manage-list<?php echo $this->pageclass_sfx; ?>">
    ...
    <div class="navbar">
        <div class="navbar-inner">
            <a class="brand" href="#"><?php echo JText::_('COM_IPROPERTY_MANAGE'); ?></a>
            <ul class="nav">
                <li class="active"><a href="#"><?php echo JText::_('COM_IPROPERTY_PROPERTIES'); ?></a></li>
                <li><a href="<?php echo JRoute::_('&layout=agentlist'); ?>"><?php echo JText::_('COM_IPROPERTY_AGENTS'); ?></a></li>
                <li><a href="<?php echo JRoute::_('&layout=companylist'); ?>"><?php echo JText::_('COM_IPROPERTY_COMPANIES'); ?></a></li>
            </ul>
        </div>
    </div>
    <div class="clearfix"> </div>
    ...
    <form action="<?php echo JRoute::_(ipropertyHelperRoute::getManageRoute().'&layout='.JFactory::getApplication()->input->get('layout','proplist')); ?>" method="post" name="adminForm" id="adminForm">
        <div id="filter-bar" class="btn-toolbar">
            <div class="filter-search btn-group pull-left">
                <label class="element-invisible" for="filter_search"><?php echo htmlentities(JText::_('JSEARCH_FILTER_LABEL')); ?></label>
            ...
            <div class="btn-group pull-left hidden-phone">
                <button class="btn hasTooltip" type="submit" title="<?php echo htmlentities(JText::_('JSEARCH_FILTER_SUBMIT')); ?>"><i class="icon-search"></i></button>
        ...
        <div class="btn-toolbar">
            <div class="btn-group">
                ...
                <?php endif; ?>                        
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('JPUBLISHED')); ?>" onclick="Joomla.submitbutton('proplist.publish')">
                    <i class="icon-ok"></i>
                </button>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('JUNPUBLISHED')); ?>" onclick="Joomla.submitbutton('proplist.unpublish')">
                    <i class="icon-ban-circle"></i>
                </button>
                <?php if ($this->ipauth->getAdmin() || $this->ipauth->getSuper()): ?>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_APPROVE')); ?>" onclick="Joomla.submitbutton('proplist.approve')">
                    <i class="icon-thumbs-up"></i> 
                </button>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_UNAPPROVE')); ?>" onclick="Joomla.submitbutton('proplist.unapprove')">
                    <i class="icon-thumbs-down"></i> 
                </button>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_FEATURE')); ?>" onclick="Joomla.submitbutton('proplist.feature')">
                    <i class="icon-star"></i> 
                </button>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_UNFEATURE')); ?>" onclick="Joomla.submitbutton('proplist.unfeature')">
                    <i class="icon-star-empty"></i> 
                </button>
                <?php endif; ?>
                <button type="button" class="btn hasTooltip" title="<?php echo htmlentities(JText::_('COM_IPROPERTY_DELETE')); ?>" onclick="if(confirm('<?php echo addslashes(JText::_('COM_IPROPERTY_CONFIRM_DELETE')); ?>')){Joomla.submitbutton('proplist.delete')}else{return false;}">
            ...
            <thead>
                <tr>
                    <th width="1%" class="center hidden-phone">
                        <input type="checkbox" name="checkall-toggle" value="" title="<?php echo htmlentities(JText::_('JGLOBAL_CHECK_ALL')); ?>" onclick="Joomla.checkAll(this)" />
                    </th>                    
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td class="has-context">
                                <div class="pull-left">
                                    ...
                                    <?php endif; ?>
                                    <?php echo '<span class="hasTip" title="'.htmlentities(ipropertyHTML::getThumbnail($item->id, '', $linktitle, 100)).'"><i class="icon-camera"></i></span>'; ?> |                                 
                                    <?php if ($canEdit) : ?>

...
$munits     = (!$this->settings->measurement_units) ? JText::_( 'Square Footage' ) : JText::_( 'COM_IPROPERTY_SQM' );
...
<div class="row-fluid ip-row<?php echo $this->k; ?> ip-overview-row" id="ip-listing-<?php echo $this->p->id; ?>">
    <div class="span12">
        ...
        <div class="span9 ip-overview-desc">
            ...
            {
                $ohcomments = ($this->p->comments) ? htmlentities($this->p->comments) : '';
            ...
            <div class="ip-overview-title">
                ...
                <?php 
                    ...
                    if( $this->p->baths ) echo '<strong>'.JText::_( 'COM_IPROPERTY_BATHS' ).':</strong> '.$this->p->baths.' &#160;&#160;';
                    if( $this->p->formattedsqft ) echo '<strong>'.$munits.':</strong> '.$this->p->formattedsqft.' &#160;&#160;';
                    if( $this->p->lotsize ) echo '<strong>'.JText::_( 'Stories' ).':</strong> '.$this->p->lotsize.' &#160;&#160;';

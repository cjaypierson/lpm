        ...
        <td class="ip-print-leftcol">
            ...
            <table width="100%" class="ip-print-details-table">
                <tr>
                    <td width="50%">
                        <?php if ($this->p->beds): ?>
                        <div><strong><?php echo JText::_('COM_IPROPERTY_BEDS'); ?>:</strong> <?php echo $this->p->beds; ?>
                        <?php endif; ?>
                        <?php if ($this->p->baths && $this->p->baths != '0.00'): ?>
                        <div><strong><?php echo JText::_('COM_IPROPERTY_BATHS'); ?>:</strong> <?php echo $this->p->baths; ?></div>
                        <?php endif; ?>
                        <?php if ($this->p->sqft): ?>
                        <div><strong><?php echo (!$this->settings->measurement_units) ? JText::_('Square Footage' ) : JText::_('COM_IPROPERTY_SQM'); ?>:</strong> <?php echo is_numeric($this->p->sqft) ? number_format($this->p->sqft) : $this->p->sqft; ?></div>
                        <?php endif; ?>
                        <?php if ($this->p->lotsize): ?>
                        <div><strong><?php echo JText::_('Stories' ); ?>:</strong> <?php echo is_numeric($this->p->lotsize) ? number_format($this->p->lotsize) : $this->p->lotsize; ?></div>
                        <?php endif; ?>
                        <?php 

...
if(!$this->form->getValue('sender_name')) $this->form->setValue('sender_name', '', ($this->user && $this->user->username) ? $this->user->username : '');
if(!$this->form->getValue('sender_email')) $this->form->setValue('sender_email', '', ($this->user && $this->user->email) ? $this->user->email : '');

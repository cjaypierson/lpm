...
var ipMapFunctions = (function(app) {
    ...
    app.buildSlider = function(input) {
        ...
        var vals = jQuery('<div class="clearfix form-inline"><input type="text" id="' + input.param + '_min" class="ip-adv-slidevalue input-small pull-left" disabled="disabled" /><label>' + input.title + '</label><input type="text" id="' + input.param + '_max" class="ip-adv-slidevalue input-small pull-right" disabled="disabled" /></div>');
        var sel_min, sel_max;
        // calculate step size

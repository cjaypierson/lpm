                    ...
                    <div class="tab-pane" id="ipcatsettings">
                        <div class="row-fluid">
                            ...
                            <div class="span6">
                                ...
                                <div class="control-group">
                                    <div class="control-label">
                                        <?php echo $this->form->getLabel('cat_featured'); ?>
                                    </div>
                                    <div class="controls">
                                        <?php echo $this->form->getInput('cat_featured'); ?>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="control-label">
                                        <?php echo $this->form->getLabel('cat_featured_pos'); ?>
                                    </div>
                                    <div class="controls">
                                        <?php echo $this->form->getInput('cat_featured_pos'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
